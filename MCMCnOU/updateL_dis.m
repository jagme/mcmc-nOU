function [newL, k] = updateL_dis(X, oldL, lambda0, mu, sigma, lambda1, jumpPar, eta, negJ)
%UPDATEL_DIS Local displacement move for the marked Poisson process of the 2-OU model 
%
% [newL, k] = updateL_dis(X, oldL, lambda0, mu, sigma, lambda1, jumpPar, eta, negJ)
%
% Input arguments:
%
%   X - observed data
