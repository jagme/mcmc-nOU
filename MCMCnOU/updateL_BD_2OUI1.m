function [newL, k] = updateL_BD_2OUI1(X, oldL, lambda0, mu, sigma, lambda1, jumpPar, eta, negJ)
%UPDATEL_DB_2OUI1 Birth-and-death algorithm for the marked Poisson process 
%of the 2-OU-I1 model 
%
